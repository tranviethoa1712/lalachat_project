...
use Illuminate\Contracts\Broadcasting\ShouldBroadcast; // broadcast in queue
use Illuminate\Contracts\Broadcasting\ShouldBroadcastNow; // broadcast immediately the message
