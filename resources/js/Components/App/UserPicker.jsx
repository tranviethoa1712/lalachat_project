...
export default function UserPicker({ value, options, onSelect }) {
    ...
    const filteredPeople = query === "" 
        ? options
        : options.filter((person) => person.name.toLowerCase()
                                                .replace(/\s+/g, "")
        ...
        <>
            <Combobox value={selected} onChange={onSelected} multiple >
               <div className="relative mt-1">
                    ...
                    text-left shadow-md focus:outline-none fovus-visible:ring-2
                    ...
                    >
                        ...
                        overflow-auto rounded-md bg-gray-900 py-1 text-base shadow-lg ring-1
                                            ...
                                            <>
                                                ...
                                                {selected ? (
                                                    <span
                                                        ...
                                                        flex items-center fl-3 text-white`}
                                                    >
                                                        <CheckIcon 
                                                            className="h-5 w-5"
                                                            aria-hidden="true"
